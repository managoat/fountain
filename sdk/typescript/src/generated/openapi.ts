...
export interface paths {
    ...
    "/api/account/inference-credential-sets/{id}": {
         ...
         * @description Refused for the default set: something has to answer which credential runs this account. Promote another first. Agents and conversations that named the deleted set fall back to the default rather than being deleted with it.
         */
