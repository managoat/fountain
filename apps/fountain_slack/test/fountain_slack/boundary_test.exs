defmodule FountainSlack.BoundaryTest do
  @moduledoc """
  ...
  describe "the extension contract" do
    ...
    test "uses two callbacks and widens the seam with none" do
      ...
      assert Extension.docs() == FountainSlack.Docs

      assert [%Fountain.Connections.Provider{slug: "slack"}] =
    ...
    test "starts no process: the application has no callback module" do
      assert Application.spec(:fountain_slack, :mod) in [nil, []]
    end
  end
end
