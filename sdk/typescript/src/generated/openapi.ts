...
export interface components {
    schemas: {
         ...
         */
        Turn: {
            /** @description The `client_request_id` of the prompt that opened this turn (#1406), or null: the caller sent none, or the turn is `autonomous`. Not unique. */
            client_request_id?: string | null;
            /** Format: date-time */
...
export interface operations {
    ...
    "FountainWeb.AdminController.reap_sandbox": {
        ...
        responses: {
            ...
            /** @description Another teardown holds this machine; retry */
            503: {
                headers: {
                    [name: string]: unknown;
                };
